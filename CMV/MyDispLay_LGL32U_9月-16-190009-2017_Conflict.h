...
public:	
	...
	//void DisEleLineAdjust(UCI::OptionsMap* o, double, double, double, double, HalconCpp::HXLDCont& );
	//void DisEleCircelAdjust(UCI::OptionsMap* o, double,double,double,double,double, HalconCpp::HXLDCont& RoiCircleHXLD);
